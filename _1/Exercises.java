...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [apple banana kiwi mango orange]
        ...
        //2b. What will this output? [apple banana grapes kiwi mango orange pear]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
        ...
        //5,6,7,8,9,10
        for (Integer  set1 :setA) {
            for ( Integer set2 :setB){
                if (setA.contains(set2)){
                    itemsContainedInBothSets.add(set2);
                }
            }
        }
