...
public class Exercises {
    ...
    private static int calculateFactorial(int number) {
        //Fix this code
        int result = 1;
        //corretto i-=2 in i-- per corretta fattorizzazione 5*4*3*2*1
    ...
    private static String reverseString(String input) {
        //Fix this code
        // fixato il ciclo for da i>=1 a i >=0
        //fixato "reversed+=" in "reversed ="
    ...
    private static void exercise3() {
        ...
        // fixato da assert.false a True per 0
